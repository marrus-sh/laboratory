...
(function() {
  var IndexRedirect, IndexRoute, ReactPureRenderMixin, Route, Router, code, codesearch, createWebSocketURL, module, run,
    slice = [].slice,
  ...
  if ((code != null) && window.opener.Laboratory) {
    window.opener.Laboratory.Events.Authentication.Granted({
      window: window,
      code: code
    });
  }
  ...
  Laboratory.Components.Columns.parts.Column = function(props) {
  ...
  Laboratory.Components.Columns.parts.GoLink = function(props) {
    return 彁(ReactRouter.Link, {
      to: props.to,
      "aria-hidden": true
    }, 彁(Laboratory.Components.Shared.parts.Icon, {
      name: props.icon
    }), props.children);
  };
  ...
  Laboratory.Components.Columns.parts.Heading = function(props) {
    return 彁('h2', {
      className: "laboratory-heading"
    }, props.icon ? 彁(Laboratory.Components.Shared.parts.Icon, {
      name: props.icon
    }) : null, props.children);
  };
  ...
  Laboratory.Components.Columns.parts.Status = React.createClass({
    ...
    render: function() {
      if (this.props.followed) {
        ...
        return 彁("article", {
          className: "laboratory-status" + (this.props.favourited ? " laboratory-status--highlighted" : "")
        }, (this.props.reblogged_by != null) || (this.props.favourited_by != null) || (this.props.in_reply_to_id != null) ? 彁.apply(null, ["aside", null].concat(slice.call(((function() {
          var ref1, ref2, ref3;
          switch (false) {
            case !((this.props.in_reply_to_id != null) && (this.props.reblogged_by != null)):
              return [彁(ReactRouter.Link, {
                  to: "/user/" + this.props.reblogged_by.id
                }, 彁("code", {
                  className: "laboratory-username"
                }, this.props.reblogged_by.username))].concat(slice.call((((ref1 = this.props.mentions) != null ? ref1.length : void 0) ? [彁(ReactIntl.FormattedMessage, {
            ...
            case !((this.props.in_reply_to_id != null) && (this.props.favourited_by != null)):
              return [彁(ReactRouter.Link, {
                  to: "/user/" + this.props.favourited_by.id
                }, 彁("code", {
                  className: "laboratory-username"
                }, this.props.favourited_by.username))].concat(slice.call((((ref2 = this.props.mentions) != null ? ref2.length : void 0) ? [彁(ReactIntl.FormattedMessage, {
            ...
            case this.props.reblogged_by == null:
              return [
                彁(ReactRouter.Link, {
                  to: "/user/" + this.props.reblogged_by.id
                }, 彁("code", {
                  className: "laboratory-username"
                }, this.props.reblogged_by.username)), 彁(ReactIntl.FormattedMessage, {
                  id: "status.boostedthispost",
                  message: " boosted this post"
                })
              ];
            case this.props.favourited_by == null:
              return [
                彁(ReactRouter.Link, {
                  to: "/user/" + this.props.favourited_by.id
                }, 彁("code", {
                  className: "laboratory-username"
                }, this.props.favourited_by.username)), 彁(ReactIntl.FormattedMessage, {
                  id: "status.highlightedthispost",
                  message: " highlighted this post"
                })
              ];
            case this.props.in_reply_to_id == null:
        ...
        }).call(this))))) : null, 彁("header", null, 彁(Laboratory.Components.Shared.parts.IDCard, {
          account: this.props.account
        }), 彁(ReactIntl.FormattedRelative, {
          value: Date.parse(this.props.created_at)
        }, (function(_this) {
          return function(formattedDate) {
            return 彁("time", {
              dateTime: _this.props.created_at,
              title: _this.props.created_at
            }, formattedDate);
          };
        })(this))), 彁("div", {
        ...
        }), 彁("footer", null, 彁(Laboratory.Components.Shared.parts.Button, {
        ...
        }), this.props.favourited ? 彁(Laboratory.Components.Shared.parts.Button, {
          className: "laboratory-button--minimal",
        ...
        }), this.props.reblogged ? 彁(Laboratory.Components.Shared.parts.Button, {
          className: "laboratory-button--minimal",
        ...
        }) : this.props.visibility !== "private" ? 彁(Laboratory.Components.Shared.parts.Button, {
          className: "laboratory-button--minimal",
  ...
  Laboratory.Components.Columns.productions.Empty = function() {
    return 彁(Laboratory.Components.Columns.parts.Column, {
      id: "laboratory-empty"
    }, 彁(Laboratory.Components.Columns.parts.Heading));
  };

  Laboratory.Components.Columns.productions.Go = function(props) {
    var key, value;
    return 彁(Laboratory.Components.Columns.parts.Column, {
      id: "laboratory-go"
    }, 彁(Laboratory.Components.Columns.parts.Heading, {
    ...
    }, 彁(Laboratory.Components.Columns.parts.GoLink, {
      to: "/user/" + props.myID,
      icon: "list-alt"
    }, 彁(ReactIntl.FormattedMessage, {
      id: 'go.profile',
  ...
  Laboratory.Components.Columns.productions.NotFound = function() {
    return 彁(Laboratory.Components.Columns.parts.Column, {
  ...
  Laboratory.Components.Columns.productions.Notifications = React.createClass({
    ...
    componentWillMount: function() {
      return Laboratory.Events.Notifications.Requested({
        component: this
      });
    },
    componentWillUnmount: function() {
      return Laboratory.Events.Notifications.Removed({
        component: this
      });
    },
    render: function() {
      ...
      return 彁(Laboratory.Components.Columns.parts.Column, {
        ...
        ref1 = this.state.itemOrder;
        results = [];
        for (j = 0, len = ref1.length; j < len; j++) {
          id = ref1[j];
          results.push(彁(Laboratory.Components.Columns.parts.Status, this.state.items[id]));
        }
        return results;
      }).call(this)))));
    }
  ...
  Laboratory.Components.Columns.productions.Timeline = React.createClass({
    ...
    componentWillReceiveProps: function(nextProps) {
      ...
      return Laboratory.Events.Timeline.Requested({
        name: nextProps.name,
        component: this
      });
    },
    ...
    componentWillUnmount: function() {
      return Laboratory.Events.Timeline.Removed({
        name: this.props.name,
        component: this
      });
    },
    render: function() {
      var id;
      return 彁(Laboratory.Components.Columns.parts.Column, null, 彁(Laboratory.Components.Columns.parts.Heading, {
        icon: this.getIcon()
      }, 彁(ReactIntl.FormattedMessage, {
        ...
        for (j = 0, len = ref1.length; j < len; j++) {
          id = ref1[j];
          results.push(彁(Laboratory.Components.Columns.parts.Status, this.state.posts[id]));
        }
        return results;
      }).call(this)))));
    }
  ...
  Laboratory.Components.Modules.parts.Module = React.createClass({
    ...
    close: function() {
      ...
      return window.setTimeout(((function(_this) {
        return function() {
          if (_this.props.closeTo || _this.context.router.length <= 1) {
  ...
  Laboratory.Components.Modules.productions.Account = React.createClass({
    ...
    getInitialState: function() {
      return {
        account: null,
        relationship: this.props.id === this.props.myID ? Laboratory.Symbols.Relationships.SELF : null
      };
    },
    componentWillReceiveProps: function(nextProps) {
      ...
      return Laboratory.Events.Account.Requested({
        id: nextProps.id,
        component: this
      });
    },
    ...
    componentWillUnmount: function() {
      return Laboratory.Events.Account.Removed({
        id: this.props.id,
        component: this
      });
    },
    render: function() {
      if (!((this.state.account != null) && (this.state.relationship != null))) {
        return null;
      }
      return 彁(Laboratory.Components.Modules.parts.Module, {
        attributes: {
        ...
        switch (this.state.relationship) {
          case Laboratory.Symbols.Relationships.FOLLOWING:
          case Laboratory.Symbols.Relationships.MUTUALS:
            return 彁(Laboratory.Components.Shared.parts.Button, {
              label: 彁(ReactIntl.FormattedMessage, {
                id: "account.unfollow",
          ...
          case Laboratory.Symbols.Relationships.NOT_FOLLOWING:
          case Laboratory.Symbols.Relationships.FOLLOWED_BY:
            ...
            break;
          case Laboratory.Symbols.Relationships.BLOCKING:
            return 彁(Laboratory.Components.Shared.parts.Button, {
              label: 彁(ReactIntl.FormattedMessage, {
                id: "account.blocked",
          ...
          case Laboratory.Symbols.Relationships.REQUESTED:
          case Laboratory.Symbols.Relationships.REQUESTED_MUTUALS:
            return 彁(Laboratory.Components.Shared.parts.Button, {
              label: 彁(ReactIntl.FormattedMessage, {
        ...
        dangerouslySetInnerHTML: {
          __html: this.state.account.note
        }
      }), 彁("footer", null, 彁("table", null, 彁("tbody", null, 彁("tr", null, 彁("td", null, 彁("b", null, this.state.account.statuses_count), 彁(ReactIntl.FormattedMessage, {
        id: "account.statuses",
        defaultMessage: "Posts"
      })), 彁("td", null, 彁("b", null, this.state.account.following_count), 彁(ReactIntl.FormattedMessage, {
        id: "account.following",
        defaultMessage: "Follows"
      })), 彁("td", null, 彁("b", null, this.state.account.followers_count), 彁(ReactIntl.FormattedMessage, {
  ...
  Laboratory.Components.Modules.productions.Composer = React.createClass({
    ...
    render: function() {
      ...
      return 彁(Laboratory.Components.Modules.parts.Module, {
      ...
      }, 彁("header", null, this.state.account ? 彁(Laboratory.Components.Shared.parts.IDCard, {
        account: this.state.account
      }) : null), 彁(Laboratory.Components.Shared.parts.Textbox, {
        ...
        id: "laboratory-count"
      }, isNaN(this.state.charsLeft) ? "" : this.state.charsLeft), 彁(Laboratory.Components.Shared.parts.Button, {
  ...
  Laboratory.Components.Shared.parts.Button = React.createClass({
    ...
    render: function() {
      ...
      }, this.props.label, 彁("button", output_props, 彁(Laboratory.Components.Shared.parts.Icon, {
        name: this.props.icon
      })));
    }
  });

  Laboratory.Components.Shared.parts.Icon = function(props) {
    return 彁('i', {
  ...
  Laboratory.Components.Shared.parts.IDCard = function(props) {
    return 彁('div', {
    ...
    }, props.account.display_name)], [彁('code', {
      className: "laboratory-username"
    }, props.account.acct)])));
  };
  ...
  Laboratory.Components.Shared.productions.InstanceQuery = React.createClass({
    ...
    render: function() {
      return 彁(ReactIntl.IntlProvider, {
        ...
        messages: Laboratory.Locales.getL10n(this.props.locale)
      }, 彁("div", {
  ...
  Router = ReactRouter.Router, Route = ReactRouter.Route, IndexRoute = ReactRouter.IndexRoute, IndexRedirect = ReactRouter.IndexRedirect;
  ...
  Laboratory.Components.Shared.productions.Laboratory = React.createClass({
    ...
    componentWillMount: function() {
      this.history = (this.props.useBrowserHistory ? ReactRouter.useRouterHistory(History.createHistory) : ReactRouter.useRouterHistory(History.createHashHistory))({
        basename: this.props.routerBase
      });
      this.routes = 彁(Route, {
        path: '/',
        component: (function(_this) {
          return function(props) {
            return 彁(Laboratory.Components.UI.productions.UI, {
        ...
        onEnter: (function(_this) {
          return function() {
            return _this.setThirdColumn(Laboratory.Components.Columns.productions.Go, {
        ...
        onEnter: (function(_this) {
          return function() {
            return _this.setThirdColumn(Laboratory.Components.Modules.productions.Start);
          };
        })(this)
      }), 彁(Route, {
        path: 'global',
        onEnter: (function(_this) {
          return function() {
            return _this.setThirdColumn(Laboratory.Components.Columns.productions.Timeline, {
              name: 'global'
            });
          };
        })(this)
        ...
        path: 'post/:id',
        component: Laboratory.Components.Modules.productions.Post
      }), 彁(Route, {
        path: 'user/:id',
        component: (function(_this) {
          return function(props) {
            return 彁(Laboratory.Components.Modules.productions.Account, {
        ...
        onEnter: (function(_this) {
          return function() {
            return _this.setThirdColumn(Laboratory.Components.Columns.productions.NotFound);
          };
        })(this)
      }));
    },
  ...
  Laboratory.Components.UI.parts.Header = function(props) {
    return 彁('header', {
      id: "laboratory-header"
    }, 彁(Laboratory.Components.UI.parts.Title, null, props.title), 彁(ReactRouter.Link, {
      to: "/compose"
    }, 彁(Laboratory.Components.Shared.parts.Button, {
  ...
  Laboratory.Components.UI.parts.Title = function(props) {
  ...
  Laboratory.Components.UI.productions.UI = React.createClass({
      ...
      switch (e.type) {
        ...
        case "drop":
          ...
          if (e.dataTransfer && e.dataTransfer.files.length === 1) {
            return Laboratory.Events.Composer.Upload({
              file: e.dataTransfer.files.item(1)
            });
          }
      }
    },
    ...
    render: function() {
      return 彁('div', {
        id: "laboratory-ui"
      }, 彁(Laboratory.Components.UI.parts.Header, {
        title: this.props.title
      }), 彁(Laboratory.Components.Columns.productions.Timeline, {
        name: "home"
      }), 彁(Laboratory.Components.Columns.productions.Notifications), this.props.thirdColumn, this.props.children, 彁(Laboratory.Components.Modules.productions.Composer, {
  ...
  createWebSocketURL = function(url) {
    ...
    a.href = url;
    a.href = a.href;
    a.protocol = a.protocol === 'https' || a.protocol === 'wss' ? 'wss' : 'ws';
    return a.href;
  };

  Laboratory.Functions.createStream = function(accessToken, stream) {
    var ws;
    ws = new WebSocket(createWebSocketURL(STREAMING_API_BASE_URL + "/api/v1/streaming/" + stream + "?access_token=" + accessToken));
    ws.addEventListener("open", function(e) {
      return Laboratory.Events.Stream.Open({
        stream: stream
      });
    });
    ws.addEventListener("close", function(e) {
      return Laboratory.Events.Stream.Close({
        stream: stream,
        code: e.code
      });
    });
    ws.addEventListener("message", function(e) {
      return Laboratory.Events.Stream.Message({
        stream: stream,
        data: JSON.parse(e.data)
      });
    });
    ws.addEventListener("error", function(e) {
      return Laboratory.Events.Stream.Error({
        stream: stream
      });
    });
    return ws;
  ...
  Laboratory.Functions.requestFromAPI = function(location, accessToken, onComplete, params) {
    ...
    callback = function() {
      var nextMatches, prevMatches, ref1, ref2;
      prevMatches = (ref1 = request.getResponseHeader("Link")) != null ? ref1.match(/<\s*([^,]*)\s*>\s*;[^,]*[;\s]rel="?prev(?:ious)?"?/) : void 0;
      nextMatches = (ref2 = request.getResponseHeader("Link")) != null ? ref2.match(/<\s*([^,]*)\s*>\s*;[^,]*[;\s]rel="?next"?/) : void 0;
      onComplete({
        params: params,
      ...
      return request.removeEventListener("load", callback, false);
    };
    request.addEventListener("load", callback, false);
    request.send();
  };

  Laboratory.Functions.sendToAPI = function(contents, location, accessToken, onComplete, params) {
    var callback, request;
    request = new XMLHttpRequest();
  ...
  Laboratory.Handlers.Account.Requested = function(event) {
    var attribute, attributes, j, len, stateData;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Account.Requested.type)) {
      return;
    }
    attributes = ["id", "username", "acct", "display_name", "note", "url", "avatar", "header", "locked", "followers_count", "following_count", "statuses_count"];
    if (!(this.interfaces.accounts[event.detail.id] instanceof Array)) {
      Object.defineProperty(this.interfaces.accounts, event.detail.id, {
        value: [],
        enumerable: true
      });
    }
    if (event.detail.component != null) {
      this.interfaces.accounts[event.detail.id].push(event.detail.component);
    }
    if (this.accounts[event.detail.id]) {
      stateData = {};
      for (j = 0, len = attributes.length; j < len; j++) {
        attribute = attributes[j];
        stateData[attribute] = this.accounts[event.detail.id][attribute];
      }
      event.detail.component.setState({
        account: Object.freeze(stateData)
      });
    }
    Laboratory.Functions.requestFromAPI(this.auth.api + "/accounts/" + event.detail.id, this.auth.accessToken, Laboratory.Events.Account.Received);
    Laboratory.Functions.requestFromAPI(this.auth.api + "/accounts/relationships?id=" + event.detail.id, this.auth.accessToken, Laboratory.Events.Account.RelationshipsReceived);
  };
  ...
  Laboratory.Handlers.Account.Received = function(event) {
    var attribute, attributes, component, data, hasChanged, j, k, len, len1, ref1, stateData;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Account.Received.type)) {
      return;
    }
    attributes = ["id", "username", "acct", "display_name", "note", "url", "avatar", "header", "locked", "followers_count", "following_count", "statuses_count"];
    ...
    stateData = {};
    if (this.accounts[data.id]) {
      hasChanged = false;
      for (j = 0, len = attributes.length; j < len; j++) {
        attribute = attributes[j];
        stateData[attribute] = data[attribute];
        if (this.accounts[data.id][attribute] !== data[attribute]) {
          this.accounts[data.id][attribute] = data[attribute];
          hasChanged = true;
        }
      }
    } else {
      Object.defineProperty(this.accounts, data.id, {
        value: Object.seal((function(data, stateData, attributes) {
          var k, len1, newData;
          newData = {};
          for (k = 0, len1 = attributes.length; k < len1; k++) {
            attribute = attributes[k];
            stateData[attribute] = newData[attribute] = data[attribute];
          }
          return newData;
        })(data, stateData, attributes)),
        enumerable: true
      });
      hasChanged = true;
    }
    if (hasChanged && (this.interfaces.accounts[data.id] instanceof Array)) {
      ref1 = this.interfaces.accounts[data.id];
  ...
  Laboratory.Handlers.Account.RelationshipsReceived = function(event) {
    var account, j, k, len, len1, ref1, ref2, relationship;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Account.RelationshipsReceived.type)) {
      return;
    }
    if (!(event.detail.data instanceof Array)) {
      return;
    }
    ref1 = event.detail.data;
    for (j = 0, len = ref1.length; j < len; j++) {
      relationship = ref1[j];
      if (!(this.interfaces.accounts[relationship.id] instanceof Array)) {
        continue;
      }
      ref2 = this.interfaces.accounts[relationship.id];
      for (k = 0, len1 = ref2.length; k < len1; k++) {
        account = ref2[k];
        account.setState({
          relationship: (function() {
            switch (false) {
              case relationship.id !== this.auth.me:
                return Laboratory.Symbols.Relationships.SELF;
              case !relationship.blocking:
                return Laboratory.Symbols.Relationships.BLOCKING;
              case !(relationship.following && relationship.followed_by):
                return Laboratory.Symbols.Relationships.MUTUALS;
              case !relationship.following:
                return Laboratory.Symbols.Relationships.FOLLOWING;
              case !relationship.followed_by:
                return Laboratory.Symbols.Relationships.FOLLOWED_BY;
              case !(relationship.requested && relationship.followed_by):
                return Laboratory.Symbols.Relationships.REQUESTED_MUTUALS;
              case !relationship.requested:
                return Laboratory.Symbols.Relationships.REQUESTED;
              default:
                return Laboratory.Symbols.Relationships.NOT_FOLLOWING;
            }
          }).call(this)
        });
      }
  ...
  Laboratory.Handlers.Account.Removed = function(event) {
    var index;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Account.Removed.type)) {
      return;
    }
    if (!(this.interfaces.accounts[event.detail.id] instanceof Array)) {
      return;
    ...
    index = 0;
    while (!(this.interfaces.accounts[event.detail.id][index] = event.detail.component || index >= this.interfaces.accounts[event.detail.id].length)) {
      index++;
    }
    this.interfaces.accounts[event.detail.id].splice(index, 1);
  };
  ...
  Laboratory.Handlers.Authentication.ClientRequested = function(event) {
    var a, authURL, url;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Authentication.ClientRequested.type)) {
      return;
    }
    a = document.createElement("a");
    a.href = event.detail.url;
    url = a.origin;
    a.href = this.config.baseName + "/";
    authURL = a.href;
    Laboratory.Functions.sendToAPI("client_name=Laboratory+Frontend&redirect_uris=" + encodeURIComponent(authURL) + "&scopes=read+write+follow", url + "/api/v1/apps", null, Laboratory.Events.Authentication.ClientReceived, {
      url: url,
      authURL: authURL
    });
  };
  ...
  Laboratory.Handlers.Authentication.ClientReceived = function(event) {
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Authentication.ClientReceived.type)) {
      return;
    }
  ...
  Laboratory.Handlers.Authentication.Requested = function(event) {
    var a, authURL, clientID, clientSecret, redirect, ref1, ref2, url;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Authentication.Requested.type)) {
      return;
    }
    a = document.createElement("a");
    a.href = event.detail.url;
    ...
    a.href = this.config.baseName + "/";
    authURL = a.href;
    if ((event.detail.clientID != null) && (event.detail.clientSecret != null)) {
      ref1 = [authURL, event.detail.clientID, event.detail.clientSecret], redirect = ref1[0], clientID = ref1[1], clientSecret = ref1[2];
    } else if (localStorage.getItem(url)) {
      ref2 = localStorage.getItem(url).split(" ", 3), redirect = ref2[0], clientID = ref2[1], clientSecret = ref2[2];
    }
    if (!(redirect === authURL && (clientID != null) && (clientSecret != null))) {
      Laboratory.Events.Authentication.ClientRequested({
        url: url
      });
      return;
    }
  ...
  Laboratory.Handlers.Authentication.Granted = function(event) {
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Authentication.Granted.type)) {
      return;
    }
    if (!((this.auth.origin != null) && this.auth.clientID && this.auth.clientSecret && this.auth.redirect)) {
      return;
    }
    if (event.detail.window != null) {
      event.detail.window.close();
    }
    Laboratory.Functions.sendToAPI("client_id=" + this.auth.clientID + "&client_secret=" + this.auth.clientSecret + "&redirect_uri=" + encodeURIComponent(this.auth.redirect) + "&grant_type=authorization_code&code=" + event.detail.code, this.auth.origin + "/oauth/token", null, Laboratory.Events.Authentication.Received);
  };
  ...
  Laboratory.Handlers.Authentication.Received = function(event) {
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Authentication.Received.type)) {
      return;
    }
    if (!event.detail.data.access_token) {
      localStorage.setItem(this.auth.origin, "");
      Laboratory.Events.Authentication.Requested({
    ...
    localStorage.setItem(this.auth.origin, this.auth.redirect + " " + this.auth.clientID + " " + this.auth.clientSecret);
    Laboratory.Functions.requestFromAPI(this.auth.api + "/accounts/verify_credentials", this.auth.accessToken, Laboratory.Events.Authentication.Verified);
  };
  ...
  Laboratory.Handlers.Authentication.Verified = function(event) {
    var frontend;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Authentication.Verified.type)) {
      return;
    }
    this.auth.me = event.detail.data.id;
    Laboratory.Events.Account.Received({
      data: event.detail.data
    });
    frontend = 彁(Laboratory.Components.Shared.productions.Laboratory, {
      locale: this.config.locale,
      myID: this.auth.me,
      useBrowserHistory: this.config.useBrowserHistory,
      title: this.site.title || this.auth.origin,
      links: this.site.links,
      routerBase: this.config.baseName,
      maxChars: this.site.maxChars,
      defaultPrivacy: "unlisted"
    });
    ReactDOM.unmountComponentAtNode(this.config.root);
    ReactDOM.render(frontend, this.config.root);
  };
  ...
  Laboratory.Handlers.Notifications.Requested = function(event) {
    var url;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Notifications.Requested.type)) {
      return;
    }
    url = this.auth.api + "/notifications";
    if (event.detail.before != null) {
      url += "?max_id=" + event.detail.before;
    }
    if (event.detail.since != null) {
      url += (event.detail.before != null ? "&" : "?") + "since_id=" + event.detail.since;
    }
    if (event.detail.component != null) {
      this.interfaces.notifications.push(event.detail.component);
    }
    Laboratory.Functions.requestFromAPI(url, this.auth.accessToken, Laboratory.Events.Notifications.Received);
  };
  ...
  Laboratory.Handlers.Notifications.Received = function(event) {
    var attributes, id, item, itemOrder, items, j, k, l, len, len1, len2, notifications, receivedAccounts, ref1, ref2, ref3;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Notifications.Received.type)) {
      return;
    }
    if (!this.interfaces.notifications.length) {
      return;
    }
    attributes = ["id", "url", "in_reply_to_id", "content", "created_at", "reblogged", "favourited", "sensitive", "spoiler_text", "visibility"];
    items = {};
    itemOrder = [];
    receivedAccounts = [];
    ref1 = event.detail.data;
    for (j = 0, len = ref1.length; j < len; j++) {
      item = ref1[j];
      items[item.id] = (function(_this) {
        return function(item, receivedAccounts) {
          var attachment, attribute, computedItem, k, len1, mention;
          computedItem = {};
          if (item.type !== "follow") {
            for (k = 0, len1 = attributes.length; k < len1; k++) {
              attribute = attributes[k];
              computedItem[attribute] = item.status[attribute];
            }
            computedItem.media_attachments = Object.freeze((function() {
              var l, len2, ref2, results;
              ref2 = item.status.media_attachments;
              results = [];
            ...
            computedItem.mentions = Object.freeze((function() {
              var l, len2, ref2, results;
              ref2 = item.status.mentions;
              results = [];
              for (l = 0, len2 = ref2.length; l < len2; l++) {
                mention = ref2[l];
                results.push(Object.freeze({
            ...
            if (item.type !== "mention") {
              Object.defineProperty(computedItem, (function() {
                switch (item.type) {
                  case "reblog":
                    return "reblogged_by";
                  case "favourite":
                ...
                get: function() {
                  return _this.accounts[item.account.id];
                },
                enumerable: true
              });
            }
            Object.defineProperty(computedItem, "account", {
              get: function() {
                return _this.accounts[item.status.account.id];
              },
              enumerable: true
            });
            if (receivedAccounts.indexOf(item.status.account.id) === -1) {
              Laboratory.Events.Account.Received({
          ...
          if (receivedAccounts.indexOf(item.account.id) === -1) {
            Laboratory.Events.Account.Received({
              data: item.account
            });
      ...
      })(this)(item, receivedAccounts);
      itemOrder.push(item.id);
    }
    ref2 = this.notifications.itemOrder;
    for (k = 0, len1 = ref2.length; k < len1; k++) {
      id = ref2[k];
      if (!(items[id] == null)) {
        continue;
      }
      items[id] = this.notifications.items[id];
      itemOrder.push(id);
    }
    itemOrder.sort(function(a, b) {
      return b - a;
    });
    this.notifications.itemOrder = Object.freeze(itemOrder);
    this.notifications.items = Object.freeze(items);
    ref3 = this.interfaces.notifications;
    for (l = 0, len2 = ref3.length; l < len2; l++) {
      notifications = ref3[l];
  ...
  Laboratory.Handlers.Notifications.Removed = function(event) {
    var index, ref1;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Notifications.Removed.type)) {
      return;
    }
    if (!((ref1 = this.interfaces.notifications) != null ? ref1.length : void 0)) {
      return;
    }
    index = 0;
    while (!(this.interfaces.notifications[index] = event.detail.component || index >= this.interfaces.notifications.length)) {
      index++;
    }
    this.interfaces.notifications.splice(index, 1);
    if (!this.interfaces.notifications.length) {
      this.notifications.items = Object.freeze({});
      this.notifications.itemOrder = Object.freeze([]);
    }
  };
  ...
  Laboratory.Handlers.Stream.Message = function(event) {
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Stream.Message.type)) {
      return;
    }
    switch (event.detail.data.type) {
      case "update":
        return Laboratory.Events.Timeline.StatusLoaded({
          fromStream: event.detail.stream,
          payload: JSON.parse(event.detail.data.payload)
        });
      case "delete":
        return Laboratory.Events.Timeline.StatusDeleted({
          fromStream: event.detail.stream,
          payload: JSON.parse(event.detail.data.payload)
        });
      case "notification":
        return Laboratory.Events.Notifications.ItemLoaded({
          payload: JSON.parse(event.detail.data.payload)
        });
    }
  };
  ...
  Laboratory.Handlers.Timeline.Requested = function(event) {
    var name, url;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Timeline.Requested.type)) {
      return;
    }
    ...
    if (event.detail.component != null) {
      this.interfaces.timelines[name].push(event.detail.component);
    }
    Laboratory.Functions.requestFromAPI(url, this.auth.accessToken, Laboratory.Events.Timeline.Received, {
      name: name
    });
  };
  ...
  Laboratory.Handlers.Timeline.Received = function(event) {
    var attributes, id, j, k, l, len, len1, len2, name, post, postOrder, posts, receivedAccounts, ref1, ref2, ref3, ref4, timeline;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Timeline.Received.type)) {
      return;
    }
    name = event.detail.params.name;
    if (!((ref1 = this.interfaces.timelines[name]) != null ? ref1.length : void 0)) {
      return;
    }
    attributes = ["id", "url", "in_reply_to_id", "content", "created_at", "reblogged", "favourited", "sensitive", "spoiler_text", "visibility"];
    ...
    postOrder = [];
    receivedAccounts = [];
    ref2 = event.detail.data;
    for (j = 0, len = ref2.length; j < len; j++) {
      post = ref2[j];
      posts[post.id] = (function(_this) {
        return function(post, receivedAccounts) {
          var attachment, attribute, computedPost, k, len1, mention, sourcePost;
          computedPost = {};
          sourcePost = post.reblog != null ? post.reblog : post;
          for (k = 0, len1 = attributes.length; k < len1; k++) {
            attribute = attributes[k];
            computedPost[attribute] = sourcePost[attribute];
          }
          computedPost.media_attachments = Object.freeze((function() {
            var l, len2, ref3, results;
            ref3 = sourcePost.media_attachments;
            results = [];
            for (l = 0, len2 = ref3.length; l < len2; l++) {
              attachment = ref3[l];
              results.push(Object.freeze({
          ...
          computedPost.mentions = Object.freeze((function() {
            var l, len2, ref3, results;
            ref3 = sourcePost.mentions;
            results = [];
            for (l = 0, len2 = ref3.length; l < len2; l++) {
              mention = ref3[l];
              results.push(Object.freeze({
          ...
          Object.defineProperty(computedPost, "account", {
            get: function() {
              return _this.accounts[sourcePost.account.id];
            },
            enumerable: true
          });
          if (receivedAccounts.indexOf(sourcePost.account.id) === -1) {
            Laboratory.Events.Account.Received({
              data: sourcePost.account
            });
          ...
          if (post.reblog != null) {
            ...
            Object.defineProperty(computedPost, "reblogged_by", {
              get: function() {
                return _this.accounts[post.account.id];
              },
              enumerable: true
            });
            if (receivedAccounts.indexOf(post.account.id) === -1) {
              Laboratory.Events.Account.Received({
                data: post.account
              });
      ...
      })(this)(post, receivedAccounts);
      postOrder.push(post.id);
    }
    ref3 = this.timelines[name].postOrder;
    ...
    ref4 = this.interfaces.timelines[name];
  ...
  Laboratory.Handlers.Timeline.Removed = function(event) {
    var index, ref1;
    if (!((event != null) && (this != null) && event.type === Laboratory.Handlers.Timeline.Removed.type)) {
      return;
    }
    if (!((ref1 = this.interfaces.timelines[event.detail.name]) != null ? ref1.length : void 0)) {
      return;
    }
    index = 0;
    while (!(this.interfaces.timelines[event.detail.name][index] = event.detail.component || index >= this.interfaces.timelines[event.detail.name].length)) {
      index++;
    }
    this.interfaces.timelines[event.detail.name].splice(index, 1);
    if (!(this.timelines[event.detail.name] instanceof Object)) {
      return;
    }
    if (!this.interfaces.timelines[event.detail.name].length) {
      this.timelines[event.detail.name].posts = Object.freeze({});
      this.timelines[event.detail.name].postOrder = Object.freeze([]);
    }
  };
  ...
  Object.defineProperty(Laboratory.Locales, "getL10n", {
    value: function(locale) {
      return Laboratory.Locales[locale];
    }
  });

  for (module in Laboratory) {
    Object.freeze(Laboratory[module]);
  }

  for (module in Laboratory.Components) {
  ...
  run = function() {
    var category, config, elt, handler, name, object, ref1, store;
    config = JSON.parse(document.documentElement.getAttribute("data-laboratory-config"));
    if (!config) {
      if (typeof INITIAL_STATE !== "undefined" && INITIAL_STATE !== null) {
        config = {
    ...
    store = Object.freeze({
      ...
      config: Object.freeze({
        ...
        useBrowserHistory: config.useBrowserHistory || (config.useBrowserHistory == null),
        root: (function() {
          switch (false) {
    ...
    window.store = store;
    ref1 = Laboratory.Handlers;
    for (category in ref1) {
      object = ref1[category];
      for (name in object) {
        handler = object[name];
        document.addEventListener(handler.type, handler.bind(store));
      }
    }
    ReactDOM.render(彁(Laboratory.Components.Shared.productions.InstanceQuery, {
